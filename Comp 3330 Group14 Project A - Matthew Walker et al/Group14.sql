...
--
-- Database: `group14_test2`
--
CREATE DATABASE IF NOT EXISTS `group14` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `group14`;
...
CREATE TABLE IF NOT EXISTS `kennelstay` (
  ...
  `ReasonforStay` varchar(255) NOT NULL,
  `CareDetails` text,
  `ArrivalDate` date NOT NULL,
  `ExpectedStay` int NOT NULL,
...
INSERT INTO `kennelstay` (`StayID`, `ReasonforStay`, `CareDetails`, `ArrivalDate`, `ExpectedStay`, `DepartureDate`, `RoomNum`, `Deposit`, `PetID`) VALUES
(4001, 'Owner traveling', 'Special diet', '2024-10-20', 10, '2024-10-30', 'A1', 150.00, 2001),
(4002, 'Under observation', 'Medication twice a day', '2024-10-21', 6, '2024-10-25', 'B2', 200.00, 2002),
(4003, 'Owner traveling', 'Regular feeding', '2024-10-22', 7, '2024-10-31', 'C3', 100.00, 2003),
(4004, 'Post-surgery care', 'Medication twice a day', '2024-10-23', 5, '2024-11-01', 'D4', 250.00, 2004),
(4005, 'Owner traveling', 'Special diet', '2024-10-24', 11, '2024-11-02', 'E5', 200.00, 2005);
